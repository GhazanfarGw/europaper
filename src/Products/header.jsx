  ...
  return (
    <>
      {isScrolled ? (
        ...
        <header className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center pb-2 bg-white shadow-md">
          ...
          <div className="flex items-center max-w-screen-xl justify-between mx-auto w-full">
            <div className="z-30 flex-shrink-0 items-center duration-500 pb-2 md:py-0 py-3">
              <a href="/">
                ...
                <img width={200} className='block md:hidden lg:hidden items-center duration-500' src='./logo.png' alt='favicon.png'/>
              </a>
            </div>
            <div className="z-20 text-3xl md:hidden pt-3 px-3 text-black" onClick={() => setOpen(!open)}>
