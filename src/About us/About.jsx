...
function Post() {
  ...
  return (
    <>
    <div className='md:pt-28 pt-24 px-5 md:px-10 justify-center mx-auto pb-20 bg-white'>
      <div data-aos="zoom-in-up" data-aos-delay="300" className='items-center mx-auto text-[#000] max-w-screen-xl'>
        <h1 className="second md:text-5xl font-light text-2xl text-[#444444] py-3 text-center mx-5 md:pt-28">
          Who we are?
        </h1>
        <p className='third justify-center text-center mx-auto md:max-w-2xl md:text-lg font-light text-base text-[#777]'>
        ...
        <div className='mx-auto text-center md:pt-28 pt-10'>
          <span className='second md:text-4xl font-light text-2xl text-[#444444] py-3 border-b'>
            History and key milestones​
          </span>
        </div>
        <Slider {...settings} className='fourth flex mx-auto items-center gap-10 md:pt-20 pt-10'>
