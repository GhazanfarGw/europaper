...
export default function About() {
  ...
  return (
    <>
    <section id='about' className='mx-auto items-center justify-center overflow-hidden bg-[#ffffff] pt-5 scroll-smooth duration-500 md:mt-32 text-[#000]'>
        <div className='mx-auto justify-center max-w-screen-xl md:pt-20 md:px-10 px-5'>
            <div className='justify-center mx-auto items-center'>
                <p data-aos="zoom-in-up" data-aos-delay="400" data-aos-duration="400" className='block md:hidden lg:hidden uppercase text-xs font-semibold text-[#000]'>
                    About Us
                </p>
                <p data-aos="zoom-in-up" data-aos-delay="400" data-aos-duration="400" className='uppercase font-semibold text-[#201F52] pt-10 text-xs'>
                    WHO WE ARE
                </p>
                <h1 data-aos="zoom-in-up" data-aos-delay="400" data-aos-duration="400" className='md:text-4xl text-2xl mx-auto md:pt-10 pt-5 text-[#1A2B6B]'>
                    Delivering Quality Paper Products <br className='hidden md:block lg:block'/> with Care & Commitment
                </h1>
            </div>
            <div className='mx-auto md:pt-8 pt-3'>
                <div data-aos="zoom-in-up" data-aos-delay="400" data-aos-duration="400" className='tracking-wide justify-center'>
                    <p className='md:text-base text-sm text-[#6D7380]'>
            ...
            <div data-aos="zoom-in-up" data-aos-delay="400" data-aos-duration="400" className='md:mt-20 mt-10 md:text-base text-sm justify-center text-center md:max-w-screen-lg mx-auto bg-[#E6ECFB] text-[#555C6C] py-10 px-10 shadow-lg'>
