  ...
  return (
    ...
    <div className='mx-auto justify-center md:py-20 py-10 bg-[#DFE7FB]'>
        <div className='md:flex md:grid-cols-2 justify-between mx-auto overflow-hidden items-center max-w-screen-xl md:px-10 px-5'>
            <div className='md:w-48 w-20 justify-center'>
            ...
            <div className='max-w-screen-md mx-auto md:text-left pt-5'>
                <h1 className='text-[#201F52] md:text-xl text-base leading-normal'>Accreditations</h1>
                <p className='md:text-lg text-sm text-[#555C6C] pt-4 leading-normal'>
                ...
                <p className='md:text-[12px] text-[#6D7380] pt-4 text-[10px] leading-normal'>
