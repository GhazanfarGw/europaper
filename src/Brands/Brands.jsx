...
const brands = [
  ...
  { id: 10, name: "XXL Magic Towel", description: "Super absorbent, liquid lock technology. 100% pure white cellulose.", logo: "/logobrands/11.jpg" },
...
export default function BrandSlider() {
  ...
  return (
    <div className="md:flex md:flex-col items-center justify-center bg-gradient-to-b from-gray-50 to-gray-200 md:px-10 px-5 min-h-screen py-10 md:pt-32">
        <h1 data-aos="zoom-in-up" data-aos-delay="400" data-aos-duration="400" className='md:text-5xl text-3xl mx-auto text-center pt-20 md:pt-0 pb-20 text-[#1A2B6B]'>
          Insight to the Brand
        </h1>
      {/* Main Display */}
      <motion.div
