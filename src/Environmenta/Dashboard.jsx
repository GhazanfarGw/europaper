  ...
  return (
    ...
    <div className='duration-500 bg-white'>
      <div data-aos="zoom-in-up" data-aos-delay="400" data-aos-duration="400"className='bg-local md:h-24 px-5 pt-20 md:pt-0 md:px-0'>
        <img className='z-0 duration-500 w-full object-cover md:h-[44rem]' src='./enverment.jpg' alt='images'/>
      </div>
      <div className='hidden md:block lg:block md:px-16 mx-auto justify-center overflow-hidden px-5 text-center'>
        <div className='text-white md:py-20 mt-36 md:mt-16 md:pb-0'>
          <div className='text-center mx-auto'>
            <h1 data-aos="zoom-in-up" data-aos-delay="400" data-aos-duration="400" className='second md:text-5xl text-4xl tracking-wider duration-500'>
              Environmental Care
            </h1>
            <p data-aos="zoom-in-up" data-aos-delay="400" data-aos-duration="400" className='second font-sans pt-3 tracking-widest text-[#fff]'>
              Euro Papers
            </p>
          </div>
          <div className='third md:pt-5 pt-5 pb-5 md:pb-0 md:text-2xl text-lg tracking-wider max-w-screen-lg justify-center text-center mx-auto duration-500'>
            <div data-aos="zoom-in-up" data-aos-delay="400" data-aos-duration="400" className='five border-[#fff] border-l-2 mx-auto items-center relative md:h-32 h-16 md:my-3 my-5 w-0 justify-center text-center flex rounded-sm'/>
              <a 
