        ...
        <div className='mx-auto justify-center max-w-screen-xl md:pt-20 md:px-10 px-5'>
            <div className="min-h-screen md:py-12">
                ...
                <div className="mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 md:gap-6 gap-y-5 md:pt-16 pt-8">
                ...
                <div className="mx-auto md:mt-20 mt-10 md:border-t md:border-[#1A2B6B] border-opacity-20">
                    <motion.h1
                    className="md:text-4xl text-xl mx-auto md:pt-10 pt-5 text-[#1A2B6B]"
                    initial={{ opacity: 0, y: -20 }}
                    animate={{ opacity: 1, y: 0 }}
            ...
            <div className="max-w-screen-lg mx-auto md:text-base text-sm justify-center text-center py-10 md:py-20 text-gray-600">
                <p>
